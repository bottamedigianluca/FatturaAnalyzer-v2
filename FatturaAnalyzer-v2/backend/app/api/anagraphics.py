...
async def create_anagraphics(anagraphics_data: AnagraphicsCreate):
    ...
    try:
        ...
        # Usa la funzione check_duplicate_async ora implementata
...
async def check_potential_duplicates():
    ...
    try:
        ...
        # Cerca duplicati simili per denominazione
...
async def get_top_clients_analytics(
    ...
    try:
        ...
        SELECT
            ...
            COUNT(CASE WHEN i.payment_status = 'Pagata Tot.' THEN 1 END) as paid_invoices,
