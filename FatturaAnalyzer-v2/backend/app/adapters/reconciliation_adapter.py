...
# SOSTITUZIONE DIRETTA - Mantiene le stesse importazioni V4
def get_reconciliation_adapter_v4():
    """Mantiene nome V4 ma restituisce V5 ottimizzato"""
    return ReconciliationAdapterV4Compatible()

# Alias per tutte le importazioni esistenti 
reconciliation_adapter = get_reconciliation_adapter_v4
get_reconciliation_adapter = get_reconciliation_adapter_v4

# Funzioni di sistema mantenute
async def initialize_reconciliation_system_v4():
    """Alias V4 che usa V5"""
    return await initialize_reconciliation_system_v5()

async def get_system_status_v4():
    """Alias V4 che usa V5"""
    adapter = get_reconciliation_adapter_v4()
    return await adapter.get_system_status_async()

# Accesso diretto a V5 per debugging
_v5_adapter = get_reconciliation_adapter_v5
